...
import { CreditCard, Wallet, ArrowLeft, ShoppingBag, CheckCircle2 } from 'lucide-react';
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const transactionData = {
        order_id: order.id,
        amount: finalTotal,
        payment_method: paymentMethod === 'cash' ? 'cash_on_delivery' : 'credit_card',
        status: paymentMethod === 'cash' ? 'pending' : 'completed',
        transaction_details: paymentMethod === 'card'
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl lg:text-4xl font-pacifico text-gray-900">Checkout</h1>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <div className="space-y-4 mb-6">
                ...
                >
                  <div className="flex items-center">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center mr-4 ${
                      paymentMethod === 'cash' ? 'bg-primary-100' : 'bg-gray-100'
                    }`}>
                      <Wallet className={`w-6 h-6 ${
                        paymentMethod === 'cash' ? 'text-primary-600' : 'text-gray-600'
                      }`} />
                    </div>
                ...
                >
                  <div className="flex items-center">
                    <div className={`w-12 h-12 rounded-lg flex items-center justify-center mr-4 ${
                      paymentMethod === 'card' ? 'bg-primary-100' : 'bg-gray-100'
                    }`}>
